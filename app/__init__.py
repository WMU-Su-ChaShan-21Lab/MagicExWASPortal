...
from .models.myopia.production import init_production_data, update_production_data
from .models.myopia.development import init_development_data, update_development_data
from .models.create_db import init_db, drop_db, recreate_db
from .views import myopia_bp
...
def register_blueprints(app):
    app.register_blueprint(myopia_bp, url_prefix='/')
